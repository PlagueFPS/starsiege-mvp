...
export default function Steam({ className, ...props }: SVGProps) {
  return (
    <svg {...props} stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" className={cn("transition-all h-7 w-auto fill-secondary hover:fill-gray-300", className)} height="30" width="30" xmlns="http://www.w3.org/2000/svg">
